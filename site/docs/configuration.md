...
| `task_max_inflight` | n/a | `1` | Concurrent gateway requests admitted per task lease; bounds budget overshoot to this many in-flight requests; `0` disables the cap |
