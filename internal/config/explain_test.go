...
func TestExplain_CoversEveryEnvOverride(t *testing.T) {
	...
	want := []string{
		...
		"DRYDOCK_GLOBAL_BUDGET_USD", "DRYDOCK_GLOBAL_MAX_TASKS", "DRYDOCK_GLOBAL_WINDOW",
		...
		"DRYDOCK_CI_WATCH", "DRYDOCK_CI_POLL_INTERVAL", "DRYDOCK_CI_WATCH_TIMEOUT",
		"DRYDOCK_CI_MAX_ATTEMPTS",
